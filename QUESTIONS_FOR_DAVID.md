# Questions for David
Compiled during system build — send as one list when ready.

---

## Market Screen & Pricing

1. **Apple margins showing 93%** — is £2.99 the price per individual apple, or per bag? If it's per bag, `retailUnitsPerBox` needs changing from 85 (individual apples) to ~14 (bags per box) so the margin calculation is correct.

2. **Leek, Potato, Potato Loose showing avg > max** — the seasonal averages are being pulled up by old outlier prices. Can you confirm the realistic max you'd pay for each of these today so we can update the config?

3. **Potato from Dole on 3 Jun at £2.20/box** — that's 22p/kg for a 10kg box which seems very cheap. Is that price correct or was it a data entry error?

4. **Potato Loose** — last purchased from Dole in October 2025, never from Holland. Are you still stocking this? If so, does Holland supply it under a different name?

---

## Missing Invoices

5. **JR Holland invoices Sep 2025 – Apr 2026** — we have zero Holland invoices for 8 months. The account is in Devorah's name. Can you get copies from Holland? This is the biggest gap — aubergine, cucumber, peppers, leek, cherry tomatoes all have no cost data for that period, which means the CFO analysis for Embellish, Oneg and BCR Sem is incomplete.

---

## Wholesale Customer Pricing

6. **Lemon pricing for Embellish** — you charged them £4.80/box but your cost was £13.17. This needs fixing immediately. Do you want to raise the price going forward, or was it a one-off?

7. **Onion Regular pricing for Embellish and Oneg** — you're charging £17.50–£18/box but paying £16.50 at market, leaving only 6% margin. On 20+ boxes a month to Embellish alone that's almost no profit. Should be closer to £20–21/box.

---

## New Products — Sourcing Unknown

8. **Potato (Ready Peeled)** — BCR Sem buy 15–60 bags at £1.91 each regularly. Where do you source these? Which supplier, what size bag, and what do you pay? This is £143+ of their March spend alone.

9. **Potato (Soraya)** — Ness's main product, 69% of their spend (30 sacks in 3 months at £12/sack). Where do you source Soraya potatoes? Is it Dole, Holland, or a separate supplier? What's your buy price per sack?

---

## Customer Mappings to Confirm

10. **BCR Sem "tang"** — mapped to Tangerine. Is that right?

11. **BCR Sem "apple" at £21/box** — mapped to Apple Royal Gala. Is that right, or a different variety?

12. **BCR Sem "mixed peppers"** — mapped to Pepper (Red) for now. Do you sell mixed peppers as a separate product, or is it just whatever peppers you have?

13. **Moisdos and Yeshiva Gedola** — both in the system as customers but no order history. Are they active? What do they typically order and how often?
