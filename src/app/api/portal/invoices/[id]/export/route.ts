...
// Portal-scoped invoice export. The staff export route lives at /api/invoices/*,
// which the middleware blocks for wholesale_customer logins — so the portal needs
// its own endpoint under /api/portal. Scoped to the caller's own customer.
